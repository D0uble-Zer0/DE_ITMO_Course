...
- [x] Создание [подпроекта](docs/README_API.md) c целью обучения выгрузки данных в dataset с API.
- [x] Создание [подпроекта](docs/README_Scrap.md) с целью обучения сбора данных для dataset с помощью скраппинга.
...
![img.png](docs/images/table_of_types_format.png)
